...
sampleAccount = Account { Account.accountId = "acc09d46-efd2-4675-aa8e-8564d9ab65b6", phone = Valid "8012223333", customer = undefined, bankToken = undefined, credit = undefined, health = undefined, Account.transferId = Id "transfer", created = parseTime "2019-02-01T20:02:46"}
