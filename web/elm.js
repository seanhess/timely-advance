...
var author$project$Main$Accounts = function (a) {
	return {$: 'Accounts', a: a};
};
var author$project$Main$GotAccountsMsg = function (a) {
	return {$: 'GotAccountsMsg', a: a};
};
var author$project$Main$NotFound = {$: 'NotFound'};
var author$project$Main$Onboard = function (a) {
	return {$: 'Onboard', a: a};
};
...
var author$project$Nimble$Api$Account = F4(
	function (accountId, firstName, lastName, email) {
		return {accountId: accountId, email: email, firstName: firstName, lastName: lastName};
	});
var elm$json$Json$Decode$string = _Json_decodeString;
var elm$json$Json$Decode$succeed = _Json_succeed;
var author$project$Nimble$Api$decodeAccount = A3(
	...
	A3(
		...
		A3(
			...
			A3(
				...
				'accountId',
				elm$json$Json$Decode$string,
				elm$json$Json$Decode$succeed(author$project$Nimble$Api$Account)))));
...
var author$project$Nimble$Api$getAccounts = function (toMsg) {
	return elm$http$Http$request(
		{
			...
			expect: A2(
				...
				toMsg,
				elm$json$Json$Decode$list(author$project$Nimble$Api$decodeAccount)),
			headers: _List_Nil,
			method: 'GET',
...
var author$project$Page$Accounts$LoadComplete = function (a) {
	return {$: 'LoadComplete', a: a};
};
var author$project$Page$Accounts$Loading = {$: 'Loading'};
var author$project$Page$Accounts$init = _Utils_Tuple2(
	{accounts: _List_Nil, status: author$project$Page$Accounts$Loading},
	author$project$Nimble$Api$getAccounts(author$project$Page$Accounts$LoadComplete));
var author$project$Page$Onboard$init = _Utils_Tuple0;
var author$project$Page$Signup$Editing = {$: 'Editing'};
var author$project$Page$Signup$init = function (key) {
	return {
		account: {email: '', firstName: '', lastName: ''},
		key: key,
		status: author$project$Page$Signup$Editing
	};
};
			...
			switch (maybeRoute.a.$) {
				case 'Onboard':
					...
					return _Utils_Tuple2(
						author$project$Main$Onboard(author$project$Page$Onboard$init),
						elm$core$Platform$Cmd$none);
				case 'Signup':
					var _n2 = maybeRoute.a;
					return _Utils_Tuple2(
						author$project$Main$Signup(
							author$project$Page$Signup$init(key)),
						elm$core$Platform$Cmd$none);
				default:
					var _n3 = maybeRoute.a;
					var _n4 = author$project$Page$Accounts$init;
					var mod = _n4.a;
					var cmd = _n4.b;
					return _Utils_Tuple2(
						author$project$Main$Accounts(mod),
						A2(elm$core$Platform$Cmd$map, author$project$Main$GotAccountsMsg, cmd));
			}
		}
	});
var author$project$Route$Accounts = {$: 'Accounts'};
var author$project$Route$Onboard = {$: 'Onboard'};
...
var author$project$Route$parser = elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			A2(elm$url$Url$Parser$map, author$project$Route$Onboard, elm$url$Url$Parser$top),
			A2(
...
var author$project$Route$fromUrl = function (u) {
	return A2(
...
var author$project$Main$init = F3(
	function (_n0, url, key) {
		...
		var cmd = _n1.b;
		return _Utils_Tuple2(
			{key: key, page: page, url: url},
			cmd);
	});
var author$project$Main$GotOnboardMsg = function (a) {
	return {$: 'GotOnboardMsg', a: a};
};
var elm$core$Platform$Sub$batch = _Platform_batch;
var elm$core$Platform$Sub$none = elm$core$Platform$Sub$batch(_List_Nil);
var author$project$Page$Onboard$subscriptions = function (_n0) {
...
var author$project$Main$subscriptions = function (model) {
	...
	if (_n0.$ === 'Onboard') {
		...
		return A2(
			...
			author$project$Main$GotOnboardMsg,
			author$project$Page$Onboard$subscriptions(onboard));
	} else {
		return elm$core$Platform$Sub$none;
	}
};
...
var author$project$Page$Accounts$Complete = function (a) {
	return {$: 'Complete', a: a};
};
		...
		if (msg.a.$ === 'Err') {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						status: author$project$Page$Accounts$Complete(
							_List_fromArray(
								['Loading error']))
					}),
				elm$core$Platform$Cmd$none);
		} else {
			var accounts = msg.a.a;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						accounts: accounts,
						status: author$project$Page$Accounts$Complete(_List_Nil)
					}),
				elm$core$Platform$Cmd$none);
		}
	});
...
var author$project$Nimble$Api$encodeAccountInfo = function (x) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'firstName',
				elm$json$Json$Encode$string(x.firstName)),
				_Utils_Tuple2(
				'lastName',
				elm$json$Json$Encode$string(x.lastName)),
				_Utils_Tuple2(
				'email',
				elm$json$Json$Encode$string(x.email))
			]));
};
...
var author$project$Nimble$Api$postAccounts = F2(
	function (toMsg, body) {
		return elm$http$Http$request(
			{
				body: elm$http$Http$jsonBody(
					author$project$Nimble$Api$encodeAccountInfo(body)),
				expect: A2(elm$http$Http$expectJson, toMsg, author$project$Nimble$Api$decodeAccount),
				headers: _List_Nil,
				method: 'POST',
				timeout: elm$core$Maybe$Nothing,
				tracker: elm$core$Maybe$Nothing,
...
var author$project$Page$Signup$Complete = function (a) {
	return {$: 'Complete', a: a};
};
var author$project$Page$Signup$CompletedSignup = function (a) {
	return {$: 'CompletedSignup', a: a};
};
var author$project$Page$Signup$Loading = {$: 'Loading'};
var author$project$Route$url = function (page) {
	var pieces = function () {
		switch (page.$) {
			case 'Onboard':
				return _List_Nil;
		...
		switch (msg.$) {
			...
			case 'Submit':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{status: author$project$Page$Signup$Loading}),
					A2(author$project$Nimble$Api$postAccounts, author$project$Page$Signup$CompletedSignup, model.account));
			default:
				if (msg.a.$ === 'Err') {
					var e = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								status: author$project$Page$Signup$Complete(
									_List_fromArray(
										['Signup server error']))
							}),
						elm$core$Platform$Cmd$none);
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								status: author$project$Page$Signup$Complete(_List_Nil)
							}),
						A2(
							elm$browser$Browser$Navigation$pushUrl,
							model.key,
							author$project$Route$url(author$project$Route$Accounts)));
				}
		}
	});
				...
				case 'GotSignupMsg':
					if (_n0.b.$ === 'Signup') {
						...
						return A4(
							...
							model,
							A2(author$project$Page$Signup$update, sub, m));
					} else {
						break _n0$6;
					}
				default:
					if (_n0.b.$ === 'Accounts') {
						...
						return A4(
							author$project$Main$updateWith,
							author$project$Main$Accounts,
							author$project$Main$GotAccountsMsg,
							model,
							A2(author$project$Page$Accounts$update, acc, m));
					} else {
						break _n0$6;
					}
			}
...
var author$project$Nimble$Style$formPage = _List_fromArray(
	[
...
var author$project$Nimble$Style$header = _List_fromArray(
	[
...
var author$project$Page$Accounts$accountView = function (account) {
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_Nil,
				mdgriffith$elm_ui$Element$text(account.accountId)),
				A2(
				mdgriffith$elm_ui$Element$el,
				_List_Nil,
				mdgriffith$elm_ui$Element$text(account.firstName)),
				A2(
				mdgriffith$elm_ui$Element$el,
				_List_Nil,
				mdgriffith$elm_ui$Element$text(account.lastName)),
				A2(
				mdgriffith$elm_ui$Element$el,
				_List_Nil,
				mdgriffith$elm_ui$Element$text(account.email))
			]));
};
...
var author$project$Page$Accounts$view = function (model) {
	return A2(
		...
		author$project$Nimble$Style$formPage,
		_List_fromArray(
			[
				A2(
				mdgriffith$elm_ui$Element$el,
				author$project$Nimble$Style$header,
				mdgriffith$elm_ui$Element$text('Accounts')),
				A2(
				mdgriffith$elm_ui$Element$column,
				_List_Nil,
				A2(elm$core$List$map, author$project$Page$Accounts$accountView, model.accounts))
			]));
};
...
var author$project$Nimble$Style$blue = A3(mdgriffith$elm_ui$Element$rgb, 0, 0, 0.8);
var author$project$Nimble$Style$darkBlue = A3(mdgriffith$elm_ui$Element$rgb, 0, 0, 0.9);
var author$project$Nimble$Style$white = A3(mdgriffith$elm_ui$Element$rgb, 1, 1, 1);
...
var author$project$Nimble$Style$button = _List_fromArray(
	[
		mdgriffith$elm_ui$Element$Background$color(author$project$Nimble$Style$blue),
		mdgriffith$elm_ui$Element$Font$color(author$project$Nimble$Style$white),
		mdgriffith$elm_ui$Element$Border$color(author$project$Nimble$Style$darkBlue),
...
var author$project$Page$Onboard$view = function (_n0) {
	return A2(
		mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Element$text('The App')),
				A2(
				mdgriffith$elm_ui$Element$link,
				author$project$Nimble$Style$button,
				{
					label: mdgriffith$elm_ui$Element$text('Sign Up'),
					url: author$project$Route$url(author$project$Route$Signup)
				})
			]));
};
var author$project$Page$Signup$Update = function (a) {
	return {$: 'Update', a: a};
};
var author$project$Page$Signup$Submit = {$: 'Submit'};
...
var author$project$Page$Signup$submit = function (status) {
	switch (status.$) {
		case 'Editing':
			return A2(
				...
				author$project$Nimble$Style$button,
				{
					label: mdgriffith$elm_ui$Element$text('Create Account'),
					onPress: elm$core$Maybe$Just(author$project$Page$Signup$Submit)
				});
		case 'Loading':
			return A2(
				mdgriffith$elm_ui$Element$el,
		...
		default:
			var problems = status.a;
			return A2(
				mdgriffith$elm_ui$Element$el,
				_List_Nil,
				mdgriffith$elm_ui$Element$text(
					'Complete: ' + elm$core$String$concat(problems)));
	}
};
...
var author$project$Page$Signup$form = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					mdgriffith$elm_ui$Element$el,
					author$project$Nimble$Style$header,
					mdgriffith$elm_ui$Element$text('Create an Account')),
					A2(
						...
						]),
					{
						...
						onChange: function (_new) {
							return author$project$Page$Signup$Update(
								_Utils_update(
									account,
									{firstName: _new}));
						},
					...
					author$project$Page$Signup$submit(status)
				]));
	});
var author$project$Page$Signup$view = function (model) {
	return A2(author$project$Page$Signup$form, model.status, model.account);
};
		...
		switch (page.$) {
			...
			case 'Onboard':
				...
				return A2(
					...
					author$project$Main$GotOnboardMsg,
					author$project$Page$Onboard$view(o));
			case 'Signup':
				var s = page.a;
				return A2(
					mdgriffith$elm_ui$Element$map,
					author$project$Main$GotSignupMsg,
					author$project$Page$Signup$view(s));
			default:
				var s = page.a;
				return A2(
					mdgriffith$elm_ui$Element$map,
					author$project$Main$GotAccountsMsg,
					author$project$Page$Accounts$view(s));
		}
	};
	return {
		body: _List_fromArray(
			[
				elm$html$Html$text('The URL is: '),
				A2(
				elm$html$Html$b,
				_List_Nil,
				_List_fromArray(
...
_Platform_export({'Main':{'init':author$project$Main$main(elm$json$Json$Decode$value)({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Page.Onboard.Msg":{"args":[],"type":"()"},"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Nimble.Api.Account":{"args":[],"type":"{ accountId : String.String, firstName : String.String, lastName : String.String, email : String.String }"},"Nimble.Api.AccountInfo":{"args":[],"type":"{ firstName : String.String, lastName : String.String, email : String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"Ignored":[],"ChangedUrl":["Url.Url"],"ClickedLink":["Browser.UrlRequest"],"GotOnboardMsg":["Page.Onboard.Msg"],"GotSignupMsg":["Page.Signup.Msg"],"GotAccountsMsg":["Page.Accounts.Msg"]}},"Page.Accounts.Msg":{"args":[],"tags":{"LoadComplete":["Result.Result Http.Error (List.List Nimble.Api.Account)"]}},"Page.Signup.Msg":{"args":[],"tags":{"Update":["Nimble.Api.AccountInfo"],"Submit":[],"CompletedSignup":["Result.Result Http.Error Nimble.Api.Account"]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"List.List":{"args":["a"],"tags":{}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}}}}})}});}(this));